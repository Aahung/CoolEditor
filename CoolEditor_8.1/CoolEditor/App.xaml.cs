...
namespace CoolEditor
{
    public partial class App : Application
    {
        ...
        public  string DropboxApiKey = ApiKeys.DropboxApiKey;
        public  string DropboxApiSecret = ApiKeys.DropboxApiSecret;

        public LiveConnectClient OnedriveClient;
        ...
        {
            // little watson report
            LittleWatson.ReportException(e.Exception, sender.ToString() + ", unhandled exception found.");
            if (Debugger.IsAttached)
            {
        ...
        {
            // little watson report
            LittleWatson.ReportException(e.ExceptionObject, sender.ToString() + ", unhandled exception found.");
            if (Debugger.IsAttached)
            {
